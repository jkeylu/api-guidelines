...
文档译写人: John Gossman (C+E), Chris Mullins (ASG), Gareth Jones (ASG), Rob Dolin (C+E), Mark Stafford (C+E)<br/>
</div>
...
# 微软 REST API 指南
## 1 摘要
微软 REST API 指南作为设计规范，鼓励应用开发人员通过 RESTful HTTP 接口来访问资源。 为了给遵循 Microsoft REST API 指南的平台的开发者提供尽可能的平滑体验，REST APIs 应该遵循始终如一的设计准则，即：可以让用户简单和直观的的使用它们。  

这个文档确立了 Microsoft REST APIs 指南应该遵循 RESTful 接口开发的一致性。
